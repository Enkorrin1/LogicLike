...
class _LogicHousesDeductionGameViewState
  ...
  static const _solution = <int, int>{0: 2, 1: 0, 2: 1};
              ...
              child: Column(
                children: [
                  SizedBox(
                    ...
                    child: _ClueStrip(accent: widget.accent),
                  ),
...
class _ClueStrip extends StatelessWidget {
  const _ClueStrip({required this.accent});
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _VisualClue(character: 1, house: 0, accent: accent),
          Container(width: 1, height: 30, color: accent.withValues(alpha: .2)),
          _VisualClue(character: 2, house: 1, accent: accent),
          Container(width: 1, height: 30, color: accent.withValues(alpha: .2)),
          _VisualClue(character: 0, house: 2, accent: accent),
        ],
      ),
    );
  }
